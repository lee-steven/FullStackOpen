...
describe('total likes', () => {
    ...
    test('when list has only one blog and equals likes of it', () => {
...
describe('author with the most blogs', () => {
    ...
    test('of much larger list with multiple blogs', () => {
...
describe('author with the most likes', () => {
    ...
    test('when list has many multiple blogs', () => {
